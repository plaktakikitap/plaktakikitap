  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16">
      <div className="rounded-xl border border-amber-500/30 bg-amber-500/5 p-8">
        <h2 className="text-xl font-semibold text-amber-700 dark:text-[#b8934a]">
          Admin paneli için yapılandırma gerekli
        </h2>
        <p className="mt-2 text-[var(--muted-foreground)]">
          <code className="rounded bg-black/10 px-1 dark:bg-[#1a1612]/8">SUPABASE_SERVICE_ROLE_KEY</code>{" "}
        ...
        <ol className="mt-6 list-inside list-decimal space-y-2 text-sm text-[var(--muted-foreground)]">
          ...
          <li>
            <code className="rounded bg-black/10 px-1 dark:bg-[#1a1612]/8">service_role</code> (secret)
          ...
          <li>
            İsim: <code className="rounded bg-black/10 px-1 dark:bg-[#1a1612]/8">SUPABASE_SERVICE_ROLE_KEY</code>
          </li>

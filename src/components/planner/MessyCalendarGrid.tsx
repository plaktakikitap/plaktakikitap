...
export function MessyCalendarGrid({
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      <div className="flex items-baseline justify-between -skew-x-1 font-display shrink-0">
      ...
      <div className="mt-2 grid shrink-0 grid-cols-7 gap-1 text-xs opacity-70 font-sans">
      ...
      <div className="mt-1.5 grid min-h-0 flex-1 grid-cols-7 gap-1.5">
        {cells.map((d, i) => {
          const dateStr = d
